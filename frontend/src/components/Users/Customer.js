...
const Customer = () => {
  ...
  const [open, setOpen, setUser] = useState(false);
    ...
    >
      ...
      <Main open={open}>
        <Grid sx={{ display: "grid", placeItems: "center", height: "100vh" }}>
          {Updateprofile ? (
            <Box>
              <Box sx={{ backgroundColor: "#E6E6FA", my: 12, py: 5, px: 5, borderRadius: '16px' }}>
            ...
            <Box sx={{ backgroundColor: "#E6E6FA", mt: 10, py: 5, px: 8, borderRadius: '16px', maxWidth: 600 }}>
              ...
              >
                Hola {name} recuerda que debes estar al día con el pago de tus facturas, 
                en caso de que tu estado no esté activado, dirigete a la pestaña de pagos. Tu estado es: {estadostr}
              </Typography>
            </Box>
          ) : payment ? (
